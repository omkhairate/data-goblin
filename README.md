...
```sh
WINSIM_USERNAME="your-login" AUTO_BOOK_1GB=true CHECK_INTERVAL_MS=30000 LOGIN_MAX_ATTEMPTS=6 MANUAL_ATTENTION_REMINDER_MS=120000 npm run monitor
```
